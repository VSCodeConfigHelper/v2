...
curl -i -u Guyutongxue:$github_token https://uploads.github.com/repos/Guyutongxue/VSCodeConfigHelper/releases/$release_id/assets\?name\=Release-v$1.zip -X POST -F "file=@$DP0/VSCodeConfigHelper/bin/Release/Release-v$1.zip" -H "Content-Type:application/zip"
