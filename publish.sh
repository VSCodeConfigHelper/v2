...
curl -u Guyutongxue:$github_token https://uploads.github.com/repos/Guyutongxue/VSCodeConfigHelper/releases/$release_id/assets\?name\=Release-v$1.zip -X POST --data-binary @"$DP0/VSCodeConfigHelper/bin/Release/Release-v$1.zip" -H "Content-Type:application/zip" | jq
